...
<script language="javascript" type="text/javascript">
	...
	function doSaveTeacher(f){
		if(document.getElementById("teacherID").value == ""){
			alert("Teacher ID Required");
				
		}
		else if(document.getElementById("teacherName").value == ""){
			alert("Teacher Name Required");
		}
		else{
			f.action="/LearnersAcademy/addTeahcer.do";
			f.submit();
		}
	}
	function doCancelTeacher(f){
		f.action="/LearnersAcademy/teahcerInformation.do";
		f.submit();
	}
...
<body>
<html:form action="/teahcerInformation" style="margin: 0">
  ...
  <table style="width:100%;border:0;height:90%" cellpadding="0" cellspacing="0">
    <tr>
      ...
      <td width="70%" valign="top"><table width="100%">      		
           ...
           <tr>
            <td colspan="4" align="center"><h2>Teacher Information Entry Form</h2></td>
          </tr>
          <tr>
          ...
          <tr>
            <td width="10%">&nbsp;</td>
            <td width="20%"><label  class="labelL">Teacher ID : </label></td>
            <td width="60%"><input type="text" 	placeholder="Enter Teacher ID" id="teacherID" name="teacherID" required></td>
            <td width="10%">&nbsp;</td>
          </tr>
          <tr>
            <td>&nbsp;</td>
            <td><label >Teacher Name : </label></td>
            <td><input type="text" placeholder="Enter Teacher Name" id="teacherName" name="teacherName" required></td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            <td>&nbsp;</td>
            ...
            <td align="center"><button type="submit" value="savesubject"
									name="savesubject" style="width: 45%" onClick="doSaveTeacher(teacherBean)">Save</button>
              <button type="button" value="cancelsubject" name="cancelsubject"
									style="width: 45%"  onClick="doCancelTeacher(teacherBean)">Cancel</button></td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            <td colspan="4">&nbsp;</td>
          ...
          <tr>
            ...
            <table cellpadding="0" cellspacing="0">
              <thead>
     		  ...
     		  <tbody>
                <core:forEach var="bo" items="${sessionScope['oTeacherDataBean'].teacherList}" varStatus="varSt">
                  <tr>
                    <td align="center"><core:out value="${varSt.count}" /></td>
                    <td align="center"><core:out value="${bo.teacherID}"/></td>
